...
<body>
<h1>난 관리자 일꺼야. <a href="/mini02/login.jsp">
<input type="button" value="로그아웃"> </a> </h1>
<hr>
<table border="1">
<tr><th><a href="/mini02/MemberList.jsp">아이디</a></th><th>비밀번호</th><th>이름</th><th>이메일</th><th>가입일</th>
<th>등급</th><th>수정</th><th>삭제</th></tr>
<%
...
for(int i = 0; i < list.size(); i++){
	...
	<form action="MemInfo.jsp" method="post">
		<tr><td> <input type="text" name ="id" value="<%=id%>" readonly="readonly"> </td>
		<td> <input type="text" name ="pw" value="<%=pw%>" readonly="readonly"> </td>
		...
		<td> <%= joinDate%></td>
		<td> <input type="text" name ="grade" value="<%=grade%>" readonly="readonly"> </td>
		<td> <button type="submit"> 수정 </button>
		<input type="hidden" name="command" value="change"> </td>
